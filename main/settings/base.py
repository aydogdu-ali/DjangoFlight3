...
ALLOWED_HOSTS = ["127.0.0.1"] # ya da "*" yazılır.
...
MIDDLEWARE = [
    #'debug_toolbar.middleware.DebugToolbarMiddleware', #dev.py sayfasında tanıttık.
...
# Database #dev.py dosyasına import ettik.
...
#debug_toolbar INTERNAL_IPS = [ "127.0.0.1",] #dev.py sayfasında tanıttık.
